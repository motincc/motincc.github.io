...
嗨，我是 **若清**，一个在 0 和 1 的世界里修仙，在山野光影中寻根的 **「专业业余选手」**。  
我的“折腾”实验室：把时间浪费在美好的事物上。
...
**设备**
- MacBook Pro 14" (M2 Max) — 创意发动机
- 飞牛系统 (FnOS) × N100 主机 — 全天候守护数字资产  
- iPhone 14 Pro + ReLens + Liit 滤镜 — 定格生活瞬间

**技能**
- 👨‍💻 **开发 & 设计** — Python 自动化脚本，打动自己的设计稿
- 📸 **摄影** — 镜头藏偏见，也藏热爱
- ⛰️ **爬山** — 山顶吹风 = 大脑重启键
...
**清源实验室 (Qing's Lab)** 是我的自留地。  
这里不生产标准答案，只记录一个「业余爱好者」的真实踩坑日记和生活碎片。

Keep Coding, Keep Creating, and Keep Climbing. 🏔️
...
| 项目 | 描述 |
|------|------|
| **[FnNav](https://github.com/motincc/FnNav)** | 飞牛服务导航面板 — 分类管理、书签、健康检测 |
| **[xiaomi-qwenpaw](https://github.com/motincc/xiaomi-qwenpaw)** | 小爱音箱 × QwenPaw AI 对接实验 |
| **[fn-knock-skills](https://github.com/motincc/fn-knock-skills)** | 飞牛 knock 安全网关技能集 |
